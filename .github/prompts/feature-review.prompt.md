...
argument-hint: "Describe the feature or area to review (e.g. shaped dictionaries, then/elthen, unions, or a path like modules/goblin/modules/gdscript/gdscript_analyzer.cpp)"
agent: "architect"
---
...
- Hard rules in `.github/copilot-instructions.md` apply. Never touch upstream files.
