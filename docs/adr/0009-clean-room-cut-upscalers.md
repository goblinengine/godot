...
`docs/cut-upscalers.md`.

## Decision 2 â€” Header direct-edit precedent
...
- Direct edit creates a small rebase surface in one header. Accepted: unavoidable â€”
